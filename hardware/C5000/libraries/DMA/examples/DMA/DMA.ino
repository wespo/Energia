/*! @file DMA.cpp
*
*  @brief: Direct Memory Access: Configures all the DMA channels for data transfer.
...
/*! Variable to store Destination buffer addresses used during DMA
   transfers */
