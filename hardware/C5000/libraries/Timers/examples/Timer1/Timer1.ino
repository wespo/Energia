/*! @file Timer1.cpp
 *
 *  @brief Timer instance 1 demo: verifies if GPT0 decrements counter
 *
 * Time instance 1 demo:
 * Verifies whether the GPT0 is decrementing the counter or not.
 * GPT is configured with a count value of 0xFFFF and pre-scaler divider
 * value of 256. GPT0 is started and counter value is read. After few
 * cycles of delay GPT0 counter value is read again. Both the counter values
