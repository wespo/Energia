/*! @file Timer2.cpp
 *
 *  @brief Timer instance 2 demo: verifies if GPT1 decrements counter
 *
 * This test verifies whether the GPT1 is decrementing the counter or not.
 * GPT1 is configured with a count value of 0x20000 and pre-scaler divider
 * value of 2. GPT1 is started and counter value is read. After few
